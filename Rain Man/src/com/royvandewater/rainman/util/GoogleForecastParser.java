...
public class GoogleForecastParser extends DefaultHandler {
	...
	private boolean inForecastInformation, inCurrentConditions,
			inForecastConditions;

	public Forecast parse(InputStream inputStream)
			throws XmlPullParserException, ParserConfigurationException,
