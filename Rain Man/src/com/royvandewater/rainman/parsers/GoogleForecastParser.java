...
public class GoogleForecastParser extends DefaultHandler {
    ...
    public static Forecast retrieveForZipcode(String zipcode) throws IOException, SAXException, XmlPullParserException, ParserConfigurationException
    {
        String uri = API_URL + zipcode;
        InputStream weatherStream = NetworkFunctions.executeHttpGet(uri);
        
        GoogleForecastParser parser = new GoogleForecastParser();
        return parser.parse(weatherStream);
    }
